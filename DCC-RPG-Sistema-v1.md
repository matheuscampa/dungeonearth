...
**Descanso Diário (obrigatório).** A cada "dia" da masmorra (8 horas de ficção), todo crawler **precisa** dormir um turno. O descanso **zera cooldowns de recarga "descanso"**, **remove exaustão** e condições de longa duração, e enche HP/PM. Sem a **Cama**, o descanso consome as 8 horas in-fiction — o que **avança o relógio do andar** (não durma em lugar errado).
...
| **2** | A regeneração em Sala Segura cai pela metade; HP/PM máximos −10%. |
...
Sem combate: abrir Caixas · organizar/reequipar · falar com o Guia · loja. **Descanso Diário (8h, obrigatório):** zera cooldowns de "descanso", remove **1 nível de Exaustão** e condições longas, enche HP/PM. **Cama** (upgrade) = descansa na hora.
**Exaustão (acumula sem dormir / farm longo):** N1 −1 em tudo · N2 regen ½ e HP/PM máx −10% · N3 desloc ½, sem reações · N4 d20≤5 = Atordoado · N5 colapsa. Descanso remove 1 nível.
